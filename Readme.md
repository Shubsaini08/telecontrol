### KEEP YOUR API KEYS SAFE AND WARM BCZ ITS ALL ABOUT API KEY AND ADMINCHAT ID WHICH IS GIVEN IF SOMEONE GOT YOUR API KEY AND CHAT ID YOUR DEVICE CAN BE COOKED SO STAY SAFE KEEP THEM SECURED 
